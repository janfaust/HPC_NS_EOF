...
class Simulation {
  protected:
    ...
    FieldIterator<FlowField> _VTKIterator;          // added
    VTKStencil _VTKStencil;                         // added
  ...
  public:
    Simulation(Parameters &parameters, FlowField &flowField):
       ...
       _VTKStencil(parameters),                             // added
       _VTKIterator(_flowField,parameters,_VTKStencil)      // added
       {
       }
